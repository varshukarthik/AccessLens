    ...
    <div className="py-16 space-y-20">
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl">
          <span className="text-xs font-bold uppercase tracking-wider text-indigo-600">Enterprise Inquiries</span>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-6 lg:col-span-1">
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200/80 space-y-2 text-xs text-slate-600">
              <h4 className="font-semibold text-slate-900">Are you an employee?</h4>
              <p>
          ...
          {/* Form */}
          <div className="lg:col-span-2 bg-white p-8 sm:p-10 rounded-3xl border border-slate-200 shadow-xs">
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-600 transition"
                    />
                  </div>
                  <div>
                ...
                <div>
                  <label className="block font-semibold text-slate-700 mb-1">Inquiry / Security Requirements</label>
                  <textarea
                    rows="4"
                    required
                ...
                <button
                  type="submit"
                  className="w-full sm:w-auto px-6 py-3 bg-slate-900 hover:bg-slate-800 text-white font-semibold rounded-xl text-xs shadow-sm transition inline-flex items-center justify-center space-x-2"
                >
